...
impl<T: frame_system::Config> pallet_balances::weights::WeightInfo for WeightInfo<T> {
	...
	fn transfer_allow_death(
		...
		Weight::from_parts(50_405_000, 3569)
	...
	fn transfer_keep_alive(
		...
		Weight::from_parts(45_054_000, 3569)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_set_balance_creating(
		...
		Weight::from_parts(23_595_000, 3569)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_set_balance_killing(
		...
		Weight::from_parts(24_526_000, 3569)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn force_transfer(
		...
		Weight::from_parts(55_935_000, 6148)
	...
	fn transfer_all(
		...
		Weight::from_parts(56_526_000, 3569)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `System::Account` (r:1 w:1)
	...
	fn force_unreserve(
		...
		Weight::from_parts(19_987_000, 3569)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
...
u: u32, 	) -> Weight {
		...
		Weight::from_parts(19_867_000, 990)
			// Standard Error: 11_549
			.saturating_add(Weight::from_parts(15_917_440, 0).saturating_mul(u.into()))
